package 
{
	...
	{
		[Embed(source = "../resources/bgmusic2.mp3")]
		private var SOUND_BGMUSIC:Class;
		
		[Embed(source = "../resources/star.mp3")]
		private var SOUND_STAR:Class;
		
		[Embed(source = "../resources/aww.mp3")]
		private var SOUND_LOSE:Class;
		
		[Embed(source = "../resources/intro.mp3")]
		private var SOUND_INTRO:Class;
		...
		private function onInit(e:Event = null):void 
		{
			...
			introSound = new SOUND_INTRO();
			loseSound = new SOUND_LOSE();
			starSound = new SOUND_STAR();
